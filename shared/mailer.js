...
async function activateMail(email, token) {
    try {
        const mailOptions = {
            from: `noreply-@mymo.com <${USER}>`,
            to: email,
            subject: "Account Activation",
            html: `<h3>Activate your account to use #MyMo </h3><h4>Please click the <a href="${BaseUrl}/activate/${token}">Link</a> to activate your account</h4>`
        }
